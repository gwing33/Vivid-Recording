 ...
 */
Route::set('services', 'services')->defaults(array('controller' => 'welcome',	'action' => 'services'));
Route::set('equipment', 'equipment')->defaults(array('controller' => 'welcome',	'action' => 'equipment'));
